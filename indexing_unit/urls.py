...
urlpatterns = [
    ...
    path('<slug:slug>/issue_index_number',  IssueIndexNumber.as_view(), name='issue_index_number'),
    ...
    path('student_indexing_application_details/<slug:slug>',  StudentIndexingApplicationDetailView.as_view(), name='student_indexing_application_details'),
