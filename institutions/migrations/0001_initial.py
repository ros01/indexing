# Generated by Django 4.0.5 on 2023-07-11 07:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree_type', models.CharField(blank=True, choices=[('B.Sc', 'B.Sc'), ('M.Sc', 'M.Sc'), ('HND', 'HND'), ('ND', 'ND'), ('NCE', 'NCE')], max_length=200, null=True)),
                ('course', models.CharField(blank=True, choices=[('Physical Sciences', 'Physical Sciences'), ('Biological Sciences', 'Biological Sciences'), ('DIR', 'DIR'), ('DCR', 'DCR'), ('MIPT', 'MIPT'), ('X-RAY Technician', 'X-RAY Technician')], max_length=200, null=True)),
                ('course_grade', models.CharField(blank=True, choices=[('1st Class', '1st Class'), ('2nd Class Upper', '2nd Class Upper'), ('2nd Class Lower', '2nd Class Lower'), ('3rd Class', '3rd Class'), ('Distinction', 'Distinction'), ('Upper Credit', 'Upper Credit'), ('Lower Credit', 'Lower Credit'), ('Pass', 'Pass')], max_length=200, null=True)),
                ('degree_result', models.FileField(blank=True, null=True, upload_to='%Y/%m/%d/')),
                ('updated', models.DateTimeField(auto_now=True)),
                ('timestamp', models.DateTimeField(auto_now_add=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('matric_no', models.CharField(max_length=200, unique=True)),
                ('examination_body', models.CharField(blank=True, choices=[('Cambridge', 'Cambridge'), ('IJMB', 'IJMB'), ('JUPEB', 'JUPEB'), ('NABTEB', 'NABTEB'), ('GCE', 'GCE'), ('SAT', 'SAT')], max_length=200, null=True)),
                ('chemistry_score', models.CharField(blank=True, choices=[('A+', 'A+'), ('B', 'B'), ('C', 'C'), ('D', 'D'), ('E', 'E')], max_length=200, null=True)),
                ('biology_score', models.CharField(blank=True, choices=[('A+', 'A+'), ('B', 'B'), ('C', 'C'), ('D', 'D'), ('E', 'E')], max_length=200, null=True)),
                ('physics_score', models.CharField(blank=True, choices=[('A+', 'A+'), ('B', 'B'), ('C', 'C'), ('D', 'D'), ('E', 'E')], max_length=200, null=True)),
                ('gce_alevels_result', models.FileField(blank=True, null=True, upload_to='%Y/%m/%d/')),
                ('updated', models.DateTimeField(auto_now=True)),
                ('timestamp', models.DateTimeField(auto_now_add=True)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('matric_no', models.CharField(max_length=200, unique=True)),
                ('examination_body', models.CharField(blank=True, max_length=200, null=True)),
                ('physics_score', models.CharField(blank=True, choices=[('A1', 'A1'), ('B2', 'B2'), ('B3', 'B3'), ('C4', 'C4'), ('C5', 'C5'), ('C6', 'C6'), ('D7', 'D7'), ('D8', 'D8'), ('F9', 'F9')], max_length=200, null=True)),
                ('chemistry_score', models.CharField(blank=True, choices=[('A1', 'A1'), ('B2', 'B2'), ('B3', 'B3'), ('C4', 'C4'), ('C5', 'C5'), ('C6', 'C6'), ('D7', 'D7'), ('D8', 'D8'), ('F9', 'F9')], max_length=200, null=True)),
                ('biology_score', models.CharField(blank=True, choices=[('A1', 'A1'), ('B2', 'B2'), ('B3', 'B3'), ('C4', 'C4'), ('C5', 'C5'), ('C6', 'C6'), ('D7', 'D7'), ('D8', 'D8'), ('F9', 'F9')], max_length=200, null=True)),
                ('english_score', models.CharField(blank=True, choices=[('A1', 'A1'), ('B2', 'B2'), ('B3', 'B3'), ('C4', 'C4'), ('C5', 'C5'), ('C6', 'C6'), ('D7', 'D7'), ('D8', 'D8'), ('F9', 'F9')], max_length=200, null=True)),
                ('mathematics_score', models.CharField(blank=True, choices=[('A1', 'A1'), ('B2', 'B2'), ('B3', 'B3'), ('C4', 'C4'), ('C5', 'C5'), ('C6', 'C6'), ('D7', 'D7'), ('D8', 'D8'), ('F9', 'F9')], max_length=200, null=True)),
                ('utme_grade_result', models.FileField(blank=True, null=True, upload_to='%Y/%m/%d/')),
                ('updated', models.DateTimeField(auto_now=True)),
                ('timestamp', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('degree_result', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='institutions.degreeresults')),
                ('gce_alevels', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='institutions.gcealevels')),
                ('institution', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='institutions.institutionprofile')),
                ('student_profile', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='institutions.studentprofile')),
