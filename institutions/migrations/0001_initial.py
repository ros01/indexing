    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('institution_type', models.CharField(choices=[('University', 'University'), ('College of Health', 'College of Health')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('academic_session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='institutions.academicsession')),
                ('degree_result', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='institutions.degreeresults')),
                ('gce_alevels', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='institutions.gcealevels')),
                ('institution', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='institutions.institutionprofile')),
                ...
                ('transfer_grade', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='institutions.transfergrade')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('academic_session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='institutions.academicsession')),
                ('institution', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='institutions.institutionprofile')),
                ('student_indexing', models.ManyToManyField(to='institutions.studentindexing')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('academic_session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='institutions.academicsession')),
                ('institution', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='institutions.institutionprofile')),
                ('student_indexing', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='institutions.studentindexing')),
                ('student_profile', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='institutions.studentprofile')),
            ],
        ),
        migrations.CreateModel(
