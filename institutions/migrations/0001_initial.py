# Generated by Django 4.0.5 on 2024-01-16 09:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('degree_type', models.CharField(choices=[('B.Sc', 'B.Sc'), ('M.Sc', 'M.Sc'), ('HND', 'HND'), ('ND', 'ND'), ('NCE', 'NCE')], max_length=200, null=True)),
                ('institution', models.CharField(choices=[('University of Nigeria', 'University of Nigeria'), ('Nnamdi Azikiwe University', 'Nnamdi Azikiwe University'), ('University of Maiduguri', 'University of Maiduguri'), ('Ahmadu Bello University Zaria', 'Ahmadu Bello University Zaria'), ('University of Uyo', 'University of Uyo'), ('University of Calabar', 'University of Calabar'), ('Bayero University Kano', 'Bayero University Kano'), ('University of Lagos', 'University of Lagos'), ('Usman Danfodio University', 'Usman Danfodio University')], max_length=200, null=True)),
                ('course', models.CharField(choices=[('Physical Sciences', 'Physical Sciences'), ('Biological Sciences', 'Biological Sciences'), ('DIR', 'DIR'), ('DCR', 'DCR'), ('MIPT', 'MIPT'), ('X-RAY Technician', 'X-RAY Technician')], max_length=200, null=True)),
                ('course_grade', models.CharField(choices=[('1st Class', '1st Class'), ('2nd Class Upper', '2nd Class Upper'), ('2nd Class Lower', '2nd Class Lower'), ('3rd Class', '3rd Class'), ('Distinction', 'Distinction'), ('Upper Credit', 'Upper Credit'), ('Lower Credit', 'Lower Credit'), ('Pass', 'Pass')], max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('examination_body', models.CharField(choices=[('Cambridge', 'Cambridge'), ('IJMB', 'IJMB'), ('JUPEB', 'JUPEB'), ('NABTEB', 'NABTEB'), ('GCE', 'GCE'), ('SAT', 'SAT')], max_length=200, null=True)),
                ('chemistry_score', models.CharField(choices=[('A+', 'A+'), ('B', 'B'), ('C', 'C'), ('D', 'D'), ('E', 'E')], max_length=200, null=True)),
                ('biology_score', models.CharField(choices=[('A+', 'A+'), ('B', 'B'), ('C', 'C'), ('D', 'D'), ('E', 'E')], max_length=200, null=True)),
                ('physics_score', models.CharField(choices=[('A+', 'A+'), ('B', 'B'), ('C', 'C'), ('D', 'D'), ('E', 'E')], max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rrr_number', models.CharField(blank=True, max_length=100, null=True)),
                ('receipt_number', models.CharField(blank=True, max_length=100, null=True)),
                ('payment_amount', models.CharField(max_length=100)),
                ('payment_method', models.CharField(choices=[('Bank', 'Bank'), ('Card', 'Card'), ('Cash', 'Cash')], max_length=100)),
                ('payment_receipt', models.FileField(blank=True, null=True, upload_to='%Y/%m/%d/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('course', models.CharField(choices=[('Physical Sciences', 'Physical Sciences'), ('Biological Sciences', 'Biological Sciences'), ('DIR', 'DIR'), ('DCR', 'DCR')], max_length=200, null=True)),
                ('institution', models.CharField(choices=[('University of Nigeria', 'University of Nigeria'), ('Nnamdi Azikiwe University', 'Nnamdi Azikiwe University'), ('University of Maiduguri', 'University of Maiduguri'), ('Ahmadu Bello University Zaria', 'Ahmadu Bello University Zaria'), ('University of Uyo', 'University of Uyo'), ('University of Calabar', 'University of Calabar'), ('Bayero University Kano', 'Bayero University Kano'), ('University of Lagos', 'University of Lagos'), ('Usman Danfodio University', 'Usman Danfodio University')], max_length=200, null=True)),
                ('degree_type', models.CharField(choices=[('B.Sc', 'B.Sc'), ('M.Sc', 'M.Sc'), ('HND', 'HND'), ('ND', 'ND'), ('NCE', 'NCE')], max_length=200, null=True)),
                ('year_of_study', models.CharField(choices=[('1st Year', '1st Year'), ('2nd Year', '2nd Year'), ('3rd Year', '3rd Year'), ('4th Year', '4th Year'), ('5th Year', '5th Year')], max_length=200, null=True)),
                ('course_grade', models.CharField(choices=[('1st Class', '1st Class'), ('2nd Class Upper', '2nd Class Upper'), ('2nd Class Lower', '2nd Class Lower'), ('3rd Class', '3rd Class'), ('Distinction', 'Distinction'), ('Upper Credit', 'Upper Credit'), ('Lower Credit', 'Lower Credit'), ('Pass', 'Pass')], max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('examination_body', models.CharField(choices=[('WAEC', 'WAEC'), ('NECO', 'NECO'), ('NABTEB', 'NABTEB')], max_length=200, null=True)),
                ('physics_score', models.CharField(choices=[('A1', 'A1'), ('B2', 'B2'), ('B3', 'B3'), ('C4', 'C4'), ('C5', 'C5'), ('C6', 'C6'), ('D7', 'D7'), ('D8', 'D8'), ('F9', 'F9')], max_length=200, null=True)),
                ('chemistry_score', models.CharField(choices=[('A1', 'A1'), ('B2', 'B2'), ('B3', 'B3'), ('C4', 'C4'), ('C5', 'C5'), ('C6', 'C6'), ('D7', 'D7'), ('D8', 'D8'), ('F9', 'F9')], max_length=200, null=True)),
                ('biology_score', models.CharField(choices=[('A1', 'A1'), ('B2', 'B2'), ('B3', 'B3'), ('C4', 'C4'), ('C5', 'C5'), ('C6', 'C6'), ('D7', 'D7'), ('D8', 'D8'), ('F9', 'F9')], max_length=200, null=True)),
                ('english_score', models.CharField(choices=[('A1', 'A1'), ('B2', 'B2'), ('B3', 'B3'), ('C4', 'C4'), ('C5', 'C5'), ('C6', 'C6'), ('D7', 'D7'), ('D8', 'D8'), ('F9', 'F9')], max_length=200, null=True)),
                ('mathematics_score', models.CharField(choices=[('A1', 'A1'), ('B2', 'B2'), ('B3', 'B3'), ('C4', 'C4'), ('C5', 'C5'), ('C6', 'C6'), ('D7', 'D7'), ('D8', 'D8'), ('F9', 'F9')], max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(blank=True)),
                ('matric_no', models.CharField(max_length=200)),
                ('admission_type', models.CharField(blank=True, max_length=200, null=True)),
                ('indexing_status', models.IntegerField(default=1)),
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('academic_session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='institutions.academicsession')),
                ('degree_result', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='institutions.degreeresults')),
                ('gce_alevels', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='institutions.gcealevels')),
                ('institution', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='institutions.institutionprofile')),
                ...
                ('transfer_grade', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='institutions.transfergrade')),
                ('utme_grade', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='institutions.utmegrade')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('academic_session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='institutions.academicsession')),
                ('institution', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='institutions.institutionprofile')),
            ],
        ),
    ]
