    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('Student', 'Student'), ('Indexing Officer', 'Indexing Officer'), ('Indexing Unit', 'Indexing Unit'), ('Registrar', 'Registrar')], default='Student', max_length=20)),
